...
public class LocalFileMogileFSImpl implements MogileFS {
    ...
    public MogileResponse storeFile(final String key, final String storageClass, final File file)
    ...
    public MogileResponse storeStream(String key, String storageClass, InputStream is) throws MogileException {
        throw new UnsupportedOperationException();
    }

    public MogileResponse storeStream(String key, String storageClass, InputStream is, long fileSize)
            throws MogileException {
        throw new UnsupportedOperationException();
    }
}
