...
public class PooledMogileFSImpl extends BaseMogileFSImpl {
    ...
    public PooledMogileFSImpl(final String domain, final String trackerStrings[], final int maxTrackerConnections,
        ...
        this(domain, trackerStrings, maxTrackerConnections, maxIdleConnections, maxIdleTimeMillis, 2, false);
    }
     ...
     */
    public PooledMogileFSImpl(final String domain, final String trackerStrings[], final int maxTrackerConnections,
                              final int maxIdleConnections, final long maxIdleTimeMillis, final int maxRetries)
            throws NoTrackersException, BadHostFormatException {
        this(domain, trackerStrings, maxTrackerConnections, maxIdleConnections, maxIdleTimeMillis, maxRetries, false);
    }
     ...
     * you'll get an exception.
     *
     * @throws NoTrackersException if we can't connect to at least one tracker
     */
    public PooledMogileFSImpl(final String domain, final String trackerStrings[], final int maxTrackerConnections,
                              final int maxIdleConnections, final long maxIdleTimeMillis, int maxRetries,
